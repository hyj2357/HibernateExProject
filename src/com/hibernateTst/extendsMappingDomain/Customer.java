...
public class Customer extends BaseCustomer{
	private String name;
	private int id;
	private String customer_password,customer_email,customer_grade,customer_major,customer_room;
    private int    customer_state,customer_sex,customer_phone,customer_qq;
